...
from torchensemble import _constants as const
from torchensemble.utils.io import split_data_target
from torchensemble.utils.logging import get_tb_logger
...
class BaseModule(nn.Module):
    ...
    def _make_estimator(self):
        ...
        estimator = [estimator[0].to(self.device),estimator[1].to(self.device)]
        return estimator
